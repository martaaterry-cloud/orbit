...
const CACHE_VERSION = 'orbit-v1.3.28';
const STATIC_ASSETS = [
  './',
  './index.html',
  ...
  './icon-192.png',
  './icon-512.png',
  './css/orbit.css?v=1.3.28',
  './js/vendor/three.min.js?v=1.3.28',
  './js/vendor/GLTFLoader.js?v=1.3.28',
  './js/observatory-3d.js?v=1.3.28',
  './assets/models/observatory.glb?v=1.3.28',
  './js/constellation-utils.js?v=1.3.28',
  './data/templates.js?v=1.3.28',
  './data/constellations.js?v=1.3.28',
  './js/storage.js?v=1.3.28',
  './js/supabase.js?v=1.3.28',
  './js/stars.js?v=1.3.28',
  './js/streak.js?v=1.3.28',
  './js/journal.js?v=1.3.28',
  './js/archive.js?v=1.3.28',
  './js/app.js?v=1.3.28'
];
