...
const CACHE_VERSION = 'orbit-v1.1.0';
const STATIC_ASSETS = [
  './',
  './index.html',
  ...
  './icon-192.png',
  './icon-512.png',
  './css/orbit.css?v=1.1.0',
  './js/storage.js?v=1.1.0',
  './js/supabase.js?v=1.1.0',
  './js/stars.js?v=1.1.0',
  './js/streak.js?v=1.1.0',
  './js/journal.js?v=1.1.0',
  './js/archive.js?v=1.1.0',
  './data/constellations.js?v=1.1.0',
  './js/app.js?v=1.1.0'
];
