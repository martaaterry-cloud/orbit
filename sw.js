...
const CACHE_VERSION = 'orbit-v1.2.13';
const STATIC_ASSETS = [
  './',
  './index.html',
  ...
  './icon-192.png',
  './icon-512.png',
  './css/orbit.css?v=1.2.13',
  './data/templates.js?v=1.2.13',
  './data/constellations.js?v=1.2.13',
  './js/storage.js?v=1.2.13',
  './js/supabase.js?v=1.2.13',
  './js/stars.js?v=1.2.13',
  './js/streak.js?v=1.2.13',
  './js/journal.js?v=1.2.13',
  './js/archive.js?v=1.2.13',
  './js/app.js?v=1.2.13'
];
