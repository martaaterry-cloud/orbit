...
const CACHE_VERSION = 'orbit-v1.2.29';
const STATIC_ASSETS = [
  './',
  './index.html',
  ...
  './icon-192.png',
  './icon-512.png',
  './css/orbit.css?v=1.2.29',
  './data/templates.js?v=1.2.29',
  './data/constellations.js?v=1.2.29',
  './js/storage.js?v=1.2.29',
  './js/supabase.js?v=1.2.29',
  './js/stars.js?v=1.2.29',
  './js/streak.js?v=1.2.29',
  './js/journal.js?v=1.2.29',
  './js/archive.js?v=1.2.29',
  './js/app.js?v=1.2.29'
];
